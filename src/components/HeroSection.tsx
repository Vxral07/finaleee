    ...
    <div className="rounded-none">
      <div className="flex gap-10 items-center max-md:flex-col">
        ...
        <div className="flex flex-col w-[44%] ml-12 max-md:ml-0 max-md:w-full">
          <div className="self-stretch text-5xl ml-5 font-medium tracking-tighter leading-tight text-white max-md:mt-10  max-md:max-w-full max-md:text-4xl">
            <span className="text-cyan-500">{highlightedText} </span>
            {title}
          </div>
          {/* Description Section */}
