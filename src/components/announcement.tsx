...
export function Announcement() {
    return (
        <Dialog defaultOpen>
            <DialogContent className="bg-gradient-to-br from-[#3d4957] to-[#282e3a] text-white border-none outline-none ring-0">
                <div className="w-full flex gap-4 flex-col p-2">
                    <div className="flex items-center justify-between">
                        <img src="/dfs.png" className="max-w-[8rem]" />
                        <Logo className="max-w-[3rem] h-16" />
                    </div>
                    <div>
                        <h1 className="font-extrabold text-2xl py-2">
                            Explore Sustainable Investing with{" "}
                            <span className="text-primary">NUQI Wealth</span>
                        </h1>
                        <h3 className="font-md">
                            Join us at Dubai FinTech Summit
                        </h3>
                    </div>
                    <div className="text-sm">
                        <p>Date: 6-7 May 2024</p>
                        <p>
                            Address: Madinet Jumeirah, Dubai, United Arab
                            Emirates
                        </p>
                        <p className="font-semibold py-1">
                            Empowering Ethical Financial Decisions Globally
                        </p>
                    </div>
                    <a
                        href="https://dubaifintechsummit.com/exhibitors/?utm_medium=cpc&utm_source=google&utm_campaign="
                        target="_blank"
                        className="inline-flex items-center rounded-lg bg-opacity-50 text-white py-1 text-sm font-medium"
                    >
                        <p>Learn More</p>
