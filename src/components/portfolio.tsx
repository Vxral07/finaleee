        ...
        <div className="flex flex-col gap-8 pb-12 items-center justify-center antialiased container">
            ...
            <div className="grid md:grid-cols-3 gap-4 md:gap-8">
                <div className="max-w-xl mx-auto">
                    <div className="relative shadow-xl bg-[linear-gradient(110deg,#333_0.6%,#222)] border-[#eaeaea] dark:border-neutral-600 text-white rounded-lg p-5 overflow-hidden">
                        <svg
                        ...
                        <div className="relative pt-[6.25rem] pb-14">
                            <div className="text-xs font-bold uppercase text-primary tracking-widest mb-2">
                                Featured app
                            </div>
                        ...
                        <div className="relative text-right">
                            <a
                                className="inline-flex w-11 h-11 justify-center items-center text-primary rounded-full transition duration-150"
                                href="#0"
                            >
